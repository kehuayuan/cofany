...
<html>
	...
	<body>
		<div id="tabsTT" class="easyui-tabs" style="width:100%;height:550px;">
			<div title="问题库" style="padding:5px;">
				<div class="easyui-layout" style="width:100%;height:100%;">
					<div data-options="region:'west'" title="问题分类" style="width:20%;">
					...
					<div data-options="region:'center'" title="问题列表">
						...
						<div id="protypetools" style="padding:5px;height:auto">
							...
							<div>
								...
								<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-search">搜索问题</a>
							</div>
						</div>
					</div>
				...
				<div id="protypeWindow" class="easyui-window" title="问题分类编辑" data-options="modal:true,closed:true">
					<div style="padding:10px 60px 20px 60px">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/kl/kl.js"></script>
	</body>
</html>